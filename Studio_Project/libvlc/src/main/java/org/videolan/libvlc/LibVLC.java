...
System.out.println("TYAZID-CMD :"+ ++cmd+" setHardwareAcceleration("+hardwareAcceleration+")");
    ...
    public void setDevHardwareDecoder(int devHardwareDecoder) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setDevHardwareDecoder("+devHardwareDecoder+")");
    ...
    public void setAout(int aout) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setAout("+aout+")");
    ...
    public void setVout(int vout) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setVout("+vout+")");
        if (vout < 0)
    ...
    public void setHdmiAudioEnabled(boolean enable) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setHdmiAudioEnabled("+enable+")");
    ...
    public void setTimeStretching(boolean timeStretching) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setTimeStretching("+timeStretching+")");
    ...
    public void setDeblocking(int deblocking) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setDeblocking("+deblocking+")");
    ...
    public void setChroma(String chroma) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setChroma("+chroma+")");
    ...
    public void setVerboseMode(boolean verboseMode) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setVerboseMode("+verboseMode+")");
    ...
    {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setEqualizer("+equalizer+")");
    ...
    public void setFrameSkip(boolean frameskip) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setFrameSkip("+frameskip+")");
    ...
    public void setNetworkCaching(int networkcaching) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setNetworkCaching("+networkcaching+")");
    ...
    public void setHttpReconnect(boolean httpReconnect) {
    	System.out.println("TYAZID-CMD :"+ ++cmd+" setHttpReconnect("+httpReconnect+")");
