...
import com.google.android.exoplayer.demo.player.RawHttpRendererBuilder;
import com.google.android.exoplayer.demo.player.SmoothStreamingRendererBuilder;
import com.google.android.exoplayer.demo.player.UdpMulticastRendererBuilder;
import com.google.android.exoplayer.demo.player.UdpRtpRendererBuilder;
import com.google.android.exoplayer.demo.player.UdpUnicastRendererBuilder;
...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
	...
	private static final boolean ACTIVE_VLC_TEST_BUILDER = true;
	private static final String VLC_BUILDER_CLS="";
  ...
  private void preparePlayer() {
    ...
    System.out.println("PlayerActivity.preparePlayer() set surface frame :"+surfaceView.getHolder().getSurfaceFrame());
  ...
  public void onVideoSizeChanged(int width, int height, float pixelWidthAspectRatio) {
    ...
    if(surfaceView instanceof com.google.android.exoplayer.VideoSurfaceView)
   ((com.google.android.exoplayer.VideoSurfaceView) surfaceView).setVideoWidthHeightRatio(
  ...
  public void surfaceCreated(SurfaceHolder holder) {
    if (player != null) {
    	System.out.println("PlayerActivity.surfaceCreated() set surface  holder frame = "+holder.getSurfaceFrame()+" s="+holder.getSurface());
