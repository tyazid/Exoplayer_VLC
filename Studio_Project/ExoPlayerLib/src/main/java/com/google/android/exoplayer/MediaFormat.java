...
public class MediaFormat {
  ...
  public final android.media.MediaFormat getFrameworkMediaFormatV16() {
    if (frameworkMediaFormat == null) {
      ...
      System.out.println(">>>> maxInputSize " + maxInputSize);
      ...
      System.out.println(">>>> initializationData " + initializationData.size());
      for (int i = 0; i < initializationData.size(); i++) {
          System.out.println(">>>> initializationData " + initializationData.get(i));
      }
