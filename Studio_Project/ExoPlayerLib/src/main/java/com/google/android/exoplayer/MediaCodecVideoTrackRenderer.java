...
public class MediaCodecVideoTrackRenderer extends MediaCodecTrackRenderer {
  ...
  protected boolean isReady() {
      //Log.d("MediaCodecVideoTrackRenderer", "#####rendererReadyOrEnded(): super.isReady()="+super.isReady());
  ...
  public void handleMessage(int messageType, Object message) throws ExoPlaybackException {
    if (messageType == MSG_SET_SURFACE) {
    	System.out.println(">>> MediaCodecVideoTrackRenderer.handleMessage() >>> surface = "+surface);
    	Thread.dumpStack();
  ...
  protected void onInputFormatChanged(MediaFormatHolder holder) throws ExoPlaybackException {
      Log.d("MediaCodecVideoTrackRenderer", "######onInputFormatChanged(): --> <-- formatHolder=" + holder.format.toString());
