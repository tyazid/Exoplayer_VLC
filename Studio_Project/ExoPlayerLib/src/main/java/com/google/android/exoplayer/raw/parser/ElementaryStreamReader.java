...
/* package */ abstract class ElementaryStreamReader extends SampleQueue {
   ...
   * {@link #consume(com.google.android.exoplayer.util.ParsableByteArray, long, boolean)}. The next call to
   * {@link #consume(com.google.android.exoplayer.util.ParsableByteArray, long, boolean)} will have {@code startOfPacket == true}.
   */
