...
/**
 * Wraps a {@link com.google.android.exoplayer.hls.parser.RollingSampleBuffer}, adding higher level functionality such as enforcing that
 * the first sample returned from the queue is a keyframe, allowing splicing to another queue, and
 * so on.
 */
/* package */ public abstract class SampleQueue {
   ...
   *
   * @param holder A {@link com.google.android.exoplayer.SampleHolder} into which the sample should be read.
